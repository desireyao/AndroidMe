...
//            mBundles[i] = mBundle;
//        }
//        FragmentPagerAdapter fragmnetpageradapter = new FragmentPagerAdapter(getSupportFragmentManager(), new Class<?>[]{FragmentApp.class, FragmentApp.class}, titles, mBundles);
