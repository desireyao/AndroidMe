 ...
 * Description:
 */
public class XfermodeViewOne extends View {
    ...
    public XfermodeViewOne(Context context) {
        super(context);
        // make a ckeckerboard pattern
    }

    public XfermodeViewOne(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        Bitmap bm = Bitmap.createBitmap(
                new int[] {0xFFFFFFFF, 0xFFCCCCCC, 0xFFCCCCCC, 0xFFFFFFFF }, 2, 2, Bitmap.Config.RGB_565);
